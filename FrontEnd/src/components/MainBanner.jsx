  ...
  return (
    <div className='relative'>
        ...
        <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-20 lg:pl-24'>
         ...
         max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-14'>Freshness You Can Trust, Savings You Will Love!</h1>
       
        <div className='flex items-center mt-6 font-medium'>
            <Link to="/products" className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-gray-700 hover:bg-primary-dull transition rounded text-white cursor-pointer'>
            Shop Now
