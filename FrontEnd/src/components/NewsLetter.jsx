...
const NewsLetter = () => {
  return (
         ...
         <div className="w-full bg-white-900 px-2 text-center text-black py-20 flex flex-col items-center justify-center mt-05 pb-14">
                ...
                <div className="flex items-center justify-center mt-10 border border-slate-600 focus-within:outline focus-within:outline-indigo-600 text-sm rounded-full h-14 max-w-md w-full">
                    ...
                    <button className="bg-gray-700 text-white rounded-full h-11 mr-1 px-8 flex items-center justify-center">
                        Subscribe now
                    </button>
                </div>
            </div>
